...
const (
	...
	InvoiceService_DeterminedLimitInvoice_FullMethodName = "/invoice_iface.InvoiceService/DeterminedLimitInvoice"
)
...
type InvoiceServiceClient interface {
	...
	DeterminedLimitInvoice(ctx context.Context, in *DeterminedConfigListReq, opts ...grpc.CallOption) (*DeterminedConfigListRes, error)
}
...
func (c *invoiceServiceClient) DeterminedLimitInvoice(ctx context.Context, in *DeterminedConfigListReq, opts ...grpc.CallOption) (*DeterminedConfigListRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeterminedConfigListRes)
	err := c.cc.Invoke(ctx, InvoiceService_DeterminedLimitInvoice_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InvoiceServiceServer interface {
	...
	DeterminedLimitInvoice(context.Context, *DeterminedConfigListReq) (*DeterminedConfigListRes, error)
...
func (UnimplementedInvoiceServiceServer) DeterminedLimitInvoice(context.Context, *DeterminedConfigListReq) (*DeterminedConfigListRes, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeterminedLimitInvoice not implemented")
}
...
func _InvoiceService_DeterminedLimitInvoice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeterminedConfigListReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InvoiceServiceServer).DeterminedLimitInvoice(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InvoiceService_DeterminedLimitInvoice_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InvoiceServiceServer).DeterminedLimitInvoice(ctx, req.(*DeterminedConfigListReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InvoiceService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeterminedLimitInvoice",
			Handler:    _InvoiceService_DeterminedLimitInvoice_Handler,
		},
	},
